...
import 'package:flutter_map/src/blocs/car_pickup_bloc.dart';
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: RaisedButton(onPressed: (){}, color: Color(0xff3277D8),
                    child: Text("Araç Seç", style: TextStyle(color: Colors.white, fontSize: 16),),),
              ),)
          ],
        );
      },
