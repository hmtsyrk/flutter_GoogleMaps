...
import 'package:flutter_map/src/resource/register_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Text(
                "Kullanıcı bilgilerinizle giriş yapınız",
    ...
    var authBloc = ArjCar.of(context).autoBloc; 
    LoadingDialog.showLoadingDialog(context, "Oturum açılıyor...");
    authBloc.signIn(email, pass, () {
      ...
      LoadingDialog.hideLoadingDialog(context);
      MsgDialog.showMsgDialog(context, "Uyarı", msg);
    });
  }
}